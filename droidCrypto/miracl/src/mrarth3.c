...
void power(_MIPD_ big x, long n, big z,
           big w) { /* raise big number to int power  w=x^n *
  ...
  if (w == z) forever { /* "Russian peasant" exponentiation */
...
BOOL nroot(_MIPD_ big x, int n,
           big w) { /*  extract  lower approximation to nth root   *
