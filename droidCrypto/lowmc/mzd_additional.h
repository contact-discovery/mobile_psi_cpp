...
void mzd_xor_uint64(mzd_local_t* res, mzd_local_t const* first,
                    mzd_local_t const* second) ATTR_NONNULL;
void mzd_xor_sse(mzd_local_t* res, mzd_local_t const* first,
                 mzd_local_t const* second) ATTR_NONNULL;
void mzd_xor_sse_128(mzd_local_t* res, mzd_local_t const* first,
                     mzd_local_t const* second) ATTR_NONNULL;
void mzd_xor_sse_256(mzd_local_t* res, mzd_local_t const* first,
                     mzd_local_t const* second) ATTR_NONNULL;
void mzd_xor_avx(mzd_local_t* res, mzd_local_t const* first,
                 mzd_local_t const* second) ATTR_NONNULL;
void mzd_xor_avx_256(mzd_local_t* res, mzd_local_t const* first,
                     mzd_local_t const* second) ATTR_NONNULL;
void mzd_xor_neon(mzd_local_t* res, mzd_local_t const* first,
                  mzd_local_t const* second) ATTR_NONNULL;
void mzd_xor_neon_128(mzd_local_t* res, mzd_local_t const* first,
                      mzd_local_t const* second) ATTR_NONNULL;
void mzd_xor_neon_256(mzd_local_t* res, mzd_local_t const* first,
                      mzd_local_t const* second) ATTR_NONNULL;
...
void mzd_mul_v_uint64_30_128(mzd_local_t* c, mzd_local_t const* v,
                             mzd_local_t const* A) ATTR_NONNULL;
void mzd_mul_v_uint64_30_192(mzd_local_t* c, mzd_local_t const* v,
                             mzd_local_t const* A) ATTR_NONNULL;
void mzd_mul_v_uint64_30_256(mzd_local_t* c, mzd_local_t const* v,
                             mzd_local_t const* A) ATTR_NONNULL;
void mzd_mul_v_uint64_3(mzd_local_t* c, mzd_local_t const* v, mzd_local_t const* A) ATTR_NONNULL;
void mzd_mul_v_uint64_3_128(mzd_local_t* c, mzd_local_t const* v,
                            mzd_local_t const* A) ATTR_NONNULL;
void mzd_mul_v_uint64_3_192(mzd_local_t* c, mzd_local_t const* v,
                            mzd_local_t const* A) ATTR_NONNULL;
void mzd_mul_v_uint64_3_256(mzd_local_t* c, mzd_local_t const* v,
                            mzd_local_t const* A) ATTR_NONNULL;
// void mzd_mul_v_avx_226_30(mzd_local_t* c, mzd_local_t const* v, mzd_local_t const* A)
// ATTR_NONNULL; void mzd_mul_v_avx_226_30_popcnt(mzd_local_t* c, mzd_local_t const* v, mzd_local_t
// const* A) ATTR_NONNULL;
...
void mzd_mul_v_98_30_popcnt(mzd_local_t* c, mzd_local_t const* v,
                            mzd_local_t const* A) ATTR_NONNULL;
void mzd_mul_v_162_30_popcnt(mzd_local_t* c, mzd_local_t const* v,
                             mzd_local_t const* A) ATTR_NONNULL;
void mzd_mul_v_226_30_popcnt(mzd_local_t* c, mzd_local_t const* v,
                             mzd_local_t const* A) ATTR_NONNULL;
void mzd_mul_v_3_popcnt(mzd_local_t* c, mzd_local_t const* v, mzd_local_t const* A) ATTR_NONNULL;
void mzd_mul_v_125_3_popcnt(mzd_local_t* c, mzd_local_t const* v,
                            mzd_local_t const* A) ATTR_NONNULL;
void mzd_mul_v_189_3_popcnt(mzd_local_t* c, mzd_local_t const* v,
                            mzd_local_t const* A) ATTR_NONNULL;
void mzd_mul_v_253_3_popcnt(mzd_local_t* c, mzd_local_t const* v,
                            mzd_local_t const* A) ATTR_NONNULL;
...
void mzd_addmul_vl_neon_128(mzd_local_t* c, mzd_local_t const* v,
                            mzd_local_t const* A) ATTR_NONNULL;
...
#define READ_BIT(w, spot)                                                                          \
  ((w[(spot) / (sizeof(word) * 8)] >> ((spot) % (sizeof(word) * 8))) & WORD_C(1))
