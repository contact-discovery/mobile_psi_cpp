...
#error "expecting Miracl to have generic multi-threading"
    ...
    const EccpParams P256
    {
        256, // bitCount
        "ffffffff00000001000000000000000000000000ffffffffffffffffffffffff", // prime p
        "ffffffff00000000ffffffffffffffffbce6faada7179e84f3b9cac2fc632551", // order n (prime)
        "ffffffff00000001000000000000000000000000fffffffffffffffffffffffc", // coefficient a
        "5ac635d8aa3a93e7b3ebbd55769886bc651d06b0cc53b0f63bce3c3e27d2604b", // coefficient b
	...
	public:
		...
		EccNumber(EllipticCurve& curve, const int32_t& val);
